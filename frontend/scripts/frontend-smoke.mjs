...
try {
  ...
  assert.equal(await page.locator('[data-challenge-dot][aria-current="true"]').getAttribute('data-challenge-dot'),'0')
  await page.locator('[data-challenge-next]').click()
  await page.waitForTimeout(700)
  assert.equal(await page.locator('[data-challenge-dot][aria-current="true"]').getAttribute('data-challenge-dot'),'1')
  await page.locator('[data-challenge-dot="0"]').click()
  await page.waitForTimeout(700)
  await page.locator('[data-challenge-prev]').click()
  await page.waitForTimeout(700)
  assert.equal(await page.locator('[data-challenge-dot][aria-current="true"]').getAttribute('data-challenge-dot'),'3')
  await page.locator('.brand').focus()
  await page.locator('.brand').hover()
  await page.waitForTimeout(5200)
  assert.equal(await page.locator('[data-challenge-dot][aria-current="true"]').getAttribute('data-challenge-dot'),'0')
  ...
  await page.locator('#challengeResults [data-challenge="safety"]').click()
  ...
  await page.setViewportSize({width:1440,height:1000})
  await page.goto(base+'/pages/show-kong.html')
  assert.equal(await page.locator('.main-nav a[href="/pages/sponsored-challenge.html"]').count(),1)
