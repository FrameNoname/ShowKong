...
try {
  ...
  await page.locator('[data-project="SheetQuest"]').click()
  await page.locator('dialog.refresh-dialog').getByRole('link',{name:'ดูรายละเอียดทีม',exact:true}).click()
  await page.locator('#loginModal').waitFor({state:'visible'})
  assert.equal(new URL(page.url()).pathname,'/')
  await page.locator('#loginModal .js-close-login').click()
  ...
  await page.locator('#loginModal .js-close-login').click()
  await page.locator('#loginModal').waitFor({state:'hidden'})
  await page.locator('.trending-section .soft-link').click()
  await page.locator('#loginModal').waitFor({state:'visible'})
  assert.equal(new URL(page.url()).pathname,'/')
  await page.locator('#loginModal .js-close-login').click()
  await page.locator('#loginModal').waitFor({state:'hidden'})
  await page.locator('.main-nav a[href="/pages/post.html"]').click()
  await page.locator('#loginModal').waitFor({state:'visible'})
  assert.equal(new URL(page.url()).pathname,'/')
  await page.locator('#loginModal .js-close-login').click()
  await page.locator('#loginModal').waitFor({state:'hidden'})
  await page.locator('.start-project-link').click()
  await page.locator('#loginModal').waitFor({state:'visible'})
  assert.equal(new URL(page.url()).pathname,'/')
  await page.locator('#loginModal .js-close-login').click()
  await page.locator('#loginModal').waitFor({state:'hidden'})
  ...
  assert.equal(await page.locator('[data-team-dot][aria-current="true"]').getAttribute('data-team-dot'),'0')
  await page.locator('[data-team-next]').click()
  await page.waitForTimeout(700)
  assert.equal(await page.locator('[data-team-dot][aria-current="true"]').getAttribute('data-team-dot'),'1')
  await page.locator('[data-team-dot="0"]').click()
  await page.waitForTimeout(700)
  await page.locator('[data-team-prev]').click()
  await page.waitForTimeout(700)
  assert.equal(await page.locator('[data-team-dot][aria-current="true"]').getAttribute('data-team-dot'),'3')
  await page.locator('.brand').focus()
  await page.locator('.brand').hover()
  await page.waitForTimeout(5200)
  assert.equal(await page.locator('[data-team-dot][aria-current="true"]').getAttribute('data-team-dot'),'0')
  ...
  await page.locator('#teamGrid [data-join]').click()
